...
import com.kuyuzhiqi.testdemo.mqtt.connect.BaseConnect;
import com.kuyuzhiqi.testdemo.mqtt.utils.BuildRandomNumber;
...
//            mqttConnectOptions.setPassword("admin".toCharArray());
            ...
            Toast.makeText(MqttManager.mApp.getApplicationContext(), "错误了", Toast.LENGTH_LONG).show();
        }
    }
